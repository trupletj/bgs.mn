...
BEGIN
  ...
  INSERT INTO bgs_attendance.passenger_assignments (
    ...
    v_shift_exchange_id, v_internal_user_id, NEW.user_id,
...
CREATE TRIGGER trg_h_user_autobus_address_sync
AFTER INSERT OR UPDATE OR DELETE ON target.h_user_autobus_address
FOR EACH ROW EXECUTE FUNCTION bgs_attendance.handle_h_user_autobus_address_sync();
