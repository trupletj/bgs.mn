-- Бүлэггүй хүмүүсийг чиглэл доторх нь алба → хэлтэс → нэрээр эрэмбэлж (зөөлөн
-- бүлэглэл) ижил албаныхан зэрэгцэн нэг автобусанд унах магадлалыг нэмэгдүүлнэ.
-- Companion бүлэг хэвээр хатуу баталгаа (нэг автобус).
